...
//   return imageData;
// };
// export type SignaturePadQrCodeProps = {
//   className?: string;
//   value: string;
//   onChange: (_signatureDataUrl: string) => void;
// };
...
export const SignaturePadQrCode = ({ className, value }: SignaturePadQrCodeProps) => {
  ...
  return (
    <div className={cn('relative h-full w-full', className)}>
      <canvas
        ref={canvasRef}
        data-testid="signature-pad-display"
